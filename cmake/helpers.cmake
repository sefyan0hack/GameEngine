    ...
    foreach(target IN LISTS ARG_TARGETS)
        ...
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
            if(ASAN)
                ...
                target_link_options(${target} PUBLIC -fsanitize=address "$<$<CXX_COMPILER_ID:GNU>:-static-libasan>")
            endif()
            if(USAN)
            ...
            if(LSAN)
                ...
                target_link_options(${target} PUBLIC -fsanitize=leak "$<$<CXX_COMPILER_ID:GNU>:-static-liblsan>")
            endif()
            if(TSAN)
                target_compile_options(${target} PRIVATE -fsanitize=thread)
                target_link_options(${target} PUBLIC -fsanitize=thread "$<$<CXX_COMPILER_ID:GNU>:-static-libtsan>")
            endif()
