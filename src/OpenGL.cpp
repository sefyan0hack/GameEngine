...
auto OpenGL::init_opengl_linux(Window window) -> void
{
    ...
    int contextAttribs[] = {
        ...
        GLX_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB, 0x8252, // GLX_LOSE_CONTEXT_ON_RESET_ARB
        #ifdef DEBUG
        GLX_CONTEXT_FLAGS_ARB, 0x0001 | 0x0002,  // GLX_CONTEXT_DEBUG_BIT_ARB | GLX_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB
        #endif
        GLX_CONTEXT_PROFILE_MASK_ARB,  0x00000001,
        0
    };
